...
const Step5Preview = () => {
  ...
  const slides = [
    ...
    (
      <div style={{ ...slideStyle, background: '#fafafa' }} key="slide_6a_timeline_1">
         <div style={{ padding: '1.5rem', transform: 'scale(0.7)', transformOrigin: 'top left', width: '142%', height: '142%' }}>
    ...
    (
      <div style={{ ...slideStyle, background: '#fafafa' }} key="slide_6b_timeline_2">
         <div style={{ padding: '1.5rem', transform: 'scale(0.7)', transformOrigin: 'top left', width: '142%', height: '142%' }}>
    ...
    (
      <div style={{ ...slideStyle, background: '#fafafa' }} key="slide_6c_timeline_3">
         <div style={{ padding: '1.5rem', transform: 'scale(0.7)', transformOrigin: 'top left', width: '142%', height: '142%' }}>
